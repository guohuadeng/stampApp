            ...
            if ($inputType = $attribute->getFrontend()->getInputType())
            {
                ...
                if ('file' == $inputType) {
                    if ($fileAttributeValue) {
                        ...
                        $afterElementHtml .= '<br /><a href="'. $downloadUrl .'"><img alt="' . Mage::helper('amcustomerattr')->__('Download File') . '" title="' . Mage::helper('amcustomerattr')->__('Download File') . '" src="'. $downloadUrl .'" class="v-middle"></a>'
                            . '<a href="'. $downloadUrl .'">'. $fileName[3] . '</a><br />'
                            . '<input type="checkbox" id="' . $attribute->getAttributeCode() . '_delete_file" name="amcustomerattr_delete[' . $attribute->getAttributeCode() . ']" value="' . $fileAttributeValue . '" /> '
                            . Mage::helper('amcustomerattr')->__('Delete File')

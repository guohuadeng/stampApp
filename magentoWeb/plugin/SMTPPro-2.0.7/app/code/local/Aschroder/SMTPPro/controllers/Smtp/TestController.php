...
class Aschroder_SMTPPro_Smtp_TestController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        $body =
                ...
                "tips for using it please visit magesmtppro.com or contact me, support@sunpop.cn.\n\n" .
                "Regards,\nIvan Deng";
        ...
        if ($success) {
            $msg = $msg . "<br/>". $_helper->__("Testing complete, if you are still experiencing difficulties please visit <a target='_blank' href='http://www.sunpop.cn'>the support page</a> or contact me via <a target='_blank' href='mailto:support@sunpop.cn'>support@sunpop.cn</a> for support.");
            Mage::getSingleton('adminhtml/session')->addSuccess($msg);
        } else {
            $msg = $msg . "<br/>". $_helper->__("Testing failed,  please review the reported problems and if you need further help visit  <a target='_blank' href='http://www.sunpop.cn'>the support page</a> or contact me via <a target='_blank' href='mailto:support@sunpop.cn'>support@sunpop.cn</a> for support.");
            Mage::getSingleton('adminhtml/session')->addError($msg);
        }

...
class Sunpop_WeixinApp_Helper_Data extends Mage_Payment_Helper_Data
{
    private $_logDir  = 'weixinapp';
    ...
    {
        $this->_debug = Mage::getStoreConfig('payment/weixinapp/debug');
    }
    ...
    /**
     * Create log directory for 'weixinapp' payment method
     * Location is /public_html/var/log/weixinapp
     */

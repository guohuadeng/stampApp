...
menu.children("div").each(function(){
var item=$(this);
var _37e=$.extend({},$.parser.parseOptions(this,["name","iconCls","href",{separator:"boolean"}]),{disabled:(item.attr("disabled")?true:undefined)});
if(_37e.separator){
...
return $.extend({},$.parser.parseOptions(_3ae,["left","top",{minWidth:"number",hideOnUnhover:"boolean"}]));
};

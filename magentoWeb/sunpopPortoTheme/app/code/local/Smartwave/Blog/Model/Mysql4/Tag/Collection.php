...
class Smartwave_Blog_Model_Mysql4_Tag_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    ...
    public function getActiveTags()
    {
        $this->getSelect()
            ...
            ->limit(Mage::getStoreConfig(Smartwave_Blog_Helper_Config::XML_TAGCLOUD_SIZE))
            ->group('tag')
        ;

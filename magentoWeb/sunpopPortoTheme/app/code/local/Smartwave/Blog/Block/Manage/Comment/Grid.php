...
class Smartwave_Blog_Block_Manage_Comment_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(
            array('smartwave_blog_main' => $collection->getTable('blog/blog')), 'main_table.post_id=smartwave_blog_main.post_id',
            array('smartwave_blog_main.title')
        );

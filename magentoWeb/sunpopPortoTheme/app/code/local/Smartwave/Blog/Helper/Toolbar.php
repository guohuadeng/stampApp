...
class Smartwave_Blog_Helper_Toolbar extends Mage_Core_Block_Abstract
{
    public function create($block, $params = array())
    {
        ...
        $block->setChild('smartwave_blog_comments_toolbar', $toolbar);
    }
    ...
    {
        $block = $this->getToolbarParentBlock()->getLayout()->getBlock('smartwave_blog_list_toolbar');
        if (!$block) {

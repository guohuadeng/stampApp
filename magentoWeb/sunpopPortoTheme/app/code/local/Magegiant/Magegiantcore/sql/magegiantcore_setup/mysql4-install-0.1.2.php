...
DROP TABLE IF EXISTS {$this->getTable('magegiantcore_extension_feedbackmessage')};
DROP TABLE IF EXISTS {$this->getTable('magegiantcore_extension_feedback')};
DROP TABLE IF EXISTS {$this->getTable('magegiantcore_log')};
...
CREATE TABLE {$this->getTable('magegiantcore_log')} (
...
CREATE TABLE {$this->getTable('magegiantcore_extension_feedback')} (
...
CREATE TABLE {$this->getTable('magegiantcore_extension_feedbackmessage')} (

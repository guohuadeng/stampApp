...
class Magegiant_Magegiantcore_Model_Feedback extends Mage_Core_Model_Abstract
{
    public function _construct()
    {
        parent::_construct();
        $this->_init('magegiantcore/feedback');
    }	
	...
	public function updateData($data)
	{
		...
		//update message
		if(count($messages)){
			$messageModel = Mage::getModel('magegiantcore/feedbackmessage');
	...
	{
		return Mage::getResourceModel('magegiantcore/feedbackmessage_collection')

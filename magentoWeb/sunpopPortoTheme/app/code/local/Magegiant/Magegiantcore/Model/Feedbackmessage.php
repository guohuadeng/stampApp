...
class Magegiant_Magegiantcore_Model_Feedbackmessage extends Mage_Core_Model_Abstract
{
	...
	public function getAttachedFile()
	{
		...
		if($attachedfiles){
			...
			$siteUrl = ((int)$this->getIsCustomer() == 1) ? Mage::getBaseUrl() : Magegiant_Magegiantcore_Model_Keygen::SERVER_URL;
